...
export const WELCOME_GREETINGS: WelcomeGreeting[] = [
  { id: 'ha', languageLabel: 'Hausa', text: 'Barka da zuwa', speechLanguage: 'ha-NG' },
  {
    ...
    paragraphs: [
      ...
      "Pẹ̀lú BetaHealth, ẹrù owó ìwòsàn ti kúrò lórí yín. Ẹ kò nílò àràádọ́ta-pọun láti rí dókítà gidi. Ẹ má fòyà mọ́ pé 'báwo ni mo ṣe fẹ́ ṣe é?' bí ara kò bá yá. A ti yanjú apá yẹn fún yín.",
      ...
      'BetaHealth. Ìlera tó dunjú fún gbogbo wa. Ẹ jẹ́ kí á bẹ̀rẹ̀!',
    ],
  },
  { id: 'ig', languageLabel: 'Igbo', text: 'Nnọọ', speechLanguage: 'ig-NG' },
  {
    ...
    introLabel: 'Intro',
    paragraphs: [
      "Welcome to BetaHealth. You be hustler, you dey work hard. But when sickness come, money fit fly commot. We believe say hospital no be for only 'big man.' Beta treatment for everybody.",
      ...
      'BetaHealth. Beta health for Naija. Oya, make we start!',
    ],
  },
